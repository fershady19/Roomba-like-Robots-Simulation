...
width = 5
height = 5
cleaned_percentage = .99
trials = 1
runSimulation(robots, speed, width, height, cleaned_percentage, trials, StandardRobot)
#runSimulation(robots, speed, width, height, cleaned_percentage, trials, RandomWalkRobot)

# 1) "Time It Takes 1 - 10 Robots To Clean 80% Of A Room"
#showPlot1("Time It Takes 1 - 10 Robots To Clean 80% Of A Room", 
#          "Number of Robots", "Time-steps")
    
#
# 2) "Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms"
